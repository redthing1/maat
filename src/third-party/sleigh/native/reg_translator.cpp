...
maat::ir::Param sleigh_reg_translate_ARM64(const std::string& reg_name)
{
    ...
    // SIMD/FP registers
    // Q registers (128-bit)
    if (reg_name == "q0") return maat::ir::Reg(maat::ARM64::Z0, 127, 0);
    if (reg_name == "q1") return maat::ir::Reg(maat::ARM64::Z1, 127, 0);
    if (reg_name == "q2") return maat::ir::Reg(maat::ARM64::Z2, 127, 0);
    if (reg_name == "q3") return maat::ir::Reg(maat::ARM64::Z3, 127, 0);
    if (reg_name == "q4") return maat::ir::Reg(maat::ARM64::Z4, 127, 0);
    if (reg_name == "q5") return maat::ir::Reg(maat::ARM64::Z5, 127, 0);
    if (reg_name == "q6") return maat::ir::Reg(maat::ARM64::Z6, 127, 0);
    if (reg_name == "q7") return maat::ir::Reg(maat::ARM64::Z7, 127, 0);
    if (reg_name == "q8") return maat::ir::Reg(maat::ARM64::Z8, 127, 0);
    if (reg_name == "q9") return maat::ir::Reg(maat::ARM64::Z9, 127, 0);
    if (reg_name == "q10") return maat::ir::Reg(maat::ARM64::Z10, 127, 0);
    if (reg_name == "q11") return maat::ir::Reg(maat::ARM64::Z11, 127, 0);
    if (reg_name == "q12") return maat::ir::Reg(maat::ARM64::Z12, 127, 0);
    if (reg_name == "q13") return maat::ir::Reg(maat::ARM64::Z13, 127, 0);
    if (reg_name == "q14") return maat::ir::Reg(maat::ARM64::Z14, 127, 0);
    if (reg_name == "q15") return maat::ir::Reg(maat::ARM64::Z15, 127, 0);
    if (reg_name == "q16") return maat::ir::Reg(maat::ARM64::Z16, 127, 0);
    if (reg_name == "q17") return maat::ir::Reg(maat::ARM64::Z17, 127, 0);
    if (reg_name == "q18") return maat::ir::Reg(maat::ARM64::Z18, 127, 0);
    if (reg_name == "q19") return maat::ir::Reg(maat::ARM64::Z19, 127, 0);
    if (reg_name == "q20") return maat::ir::Reg(maat::ARM64::Z20, 127, 0);
    if (reg_name == "q21") return maat::ir::Reg(maat::ARM64::Z21, 127, 0);
    if (reg_name == "q22") return maat::ir::Reg(maat::ARM64::Z22, 127, 0);
    if (reg_name == "q23") return maat::ir::Reg(maat::ARM64::Z23, 127, 0);
    if (reg_name == "q24") return maat::ir::Reg(maat::ARM64::Z24, 127, 0);
    if (reg_name == "q25") return maat::ir::Reg(maat::ARM64::Z25, 127, 0);
    if (reg_name == "q26") return maat::ir::Reg(maat::ARM64::Z26, 127, 0);
    if (reg_name == "q27") return maat::ir::Reg(maat::ARM64::Z27, 127, 0);
    if (reg_name == "q28") return maat::ir::Reg(maat::ARM64::Z28, 127, 0);
    if (reg_name == "q29") return maat::ir::Reg(maat::ARM64::Z29, 127, 0);
    if (reg_name == "q30") return maat::ir::Reg(maat::ARM64::Z30, 127, 0);
    if (reg_name == "q31") return maat::ir::Reg(maat::ARM64::Z31, 127, 0);
    
    // D registers (64-bit)
    if (reg_name == "d0") return maat::ir::Reg(maat::ARM64::Z0, 63, 0);
    if (reg_name == "d1") return maat::ir::Reg(maat::ARM64::Z1, 63, 0);
    if (reg_name == "d2") return maat::ir::Reg(maat::ARM64::Z2, 63, 0);
    if (reg_name == "d3") return maat::ir::Reg(maat::ARM64::Z3, 63, 0);
    if (reg_name == "d4") return maat::ir::Reg(maat::ARM64::Z4, 63, 0);
    if (reg_name == "d5") return maat::ir::Reg(maat::ARM64::Z5, 63, 0);
    if (reg_name == "d6") return maat::ir::Reg(maat::ARM64::Z6, 63, 0);
    if (reg_name == "d7") return maat::ir::Reg(maat::ARM64::Z7, 63, 0);
    if (reg_name == "d8") return maat::ir::Reg(maat::ARM64::Z8, 63, 0);
    if (reg_name == "d9") return maat::ir::Reg(maat::ARM64::Z9, 63, 0);
    if (reg_name == "d10") return maat::ir::Reg(maat::ARM64::Z10, 63, 0);
    if (reg_name == "d11") return maat::ir::Reg(maat::ARM64::Z11, 63, 0);
    if (reg_name == "d12") return maat::ir::Reg(maat::ARM64::Z12, 63, 0);
    if (reg_name == "d13") return maat::ir::Reg(maat::ARM64::Z13, 63, 0);
    if (reg_name == "d14") return maat::ir::Reg(maat::ARM64::Z14, 63, 0);
    if (reg_name == "d15") return maat::ir::Reg(maat::ARM64::Z15, 63, 0);
    if (reg_name == "d16") return maat::ir::Reg(maat::ARM64::Z16, 63, 0);
    if (reg_name == "d17") return maat::ir::Reg(maat::ARM64::Z17, 63, 0);
    if (reg_name == "d18") return maat::ir::Reg(maat::ARM64::Z18, 63, 0);
    if (reg_name == "d19") return maat::ir::Reg(maat::ARM64::Z19, 63, 0);
    if (reg_name == "d20") return maat::ir::Reg(maat::ARM64::Z20, 63, 0);
    if (reg_name == "d21") return maat::ir::Reg(maat::ARM64::Z21, 63, 0);
    if (reg_name == "d22") return maat::ir::Reg(maat::ARM64::Z22, 63, 0);
    if (reg_name == "d23") return maat::ir::Reg(maat::ARM64::Z23, 63, 0);
    if (reg_name == "d24") return maat::ir::Reg(maat::ARM64::Z24, 63, 0);
    if (reg_name == "d25") return maat::ir::Reg(maat::ARM64::Z25, 63, 0);
    if (reg_name == "d26") return maat::ir::Reg(maat::ARM64::Z26, 63, 0);
    if (reg_name == "d27") return maat::ir::Reg(maat::ARM64::Z27, 63, 0);
    if (reg_name == "d28") return maat::ir::Reg(maat::ARM64::Z28, 63, 0);
    if (reg_name == "d29") return maat::ir::Reg(maat::ARM64::Z29, 63, 0);
    if (reg_name == "d30") return maat::ir::Reg(maat::ARM64::Z30, 63, 0);
    if (reg_name == "d31") return maat::ir::Reg(maat::ARM64::Z31, 63, 0);
    
    // S registers (32-bit)
    if (reg_name == "s0") return maat::ir::Reg(maat::ARM64::Z0, 31, 0);
    if (reg_name == "s1") return maat::ir::Reg(maat::ARM64::Z1, 31, 0);
    if (reg_name == "s2") return maat::ir::Reg(maat::ARM64::Z2, 31, 0);
    if (reg_name == "s3") return maat::ir::Reg(maat::ARM64::Z3, 31, 0);
    if (reg_name == "s4") return maat::ir::Reg(maat::ARM64::Z4, 31, 0);
    if (reg_name == "s5") return maat::ir::Reg(maat::ARM64::Z5, 31, 0);
    if (reg_name == "s6") return maat::ir::Reg(maat::ARM64::Z6, 31, 0);
    if (reg_name == "s7") return maat::ir::Reg(maat::ARM64::Z7, 31, 0);
    if (reg_name == "s8") return maat::ir::Reg(maat::ARM64::Z8, 31, 0);
    if (reg_name == "s9") return maat::ir::Reg(maat::ARM64::Z9, 31, 0);
    if (reg_name == "s10") return maat::ir::Reg(maat::ARM64::Z10, 31, 0);
    if (reg_name == "s11") return maat::ir::Reg(maat::ARM64::Z11, 31, 0);
    if (reg_name == "s12") return maat::ir::Reg(maat::ARM64::Z12, 31, 0);
    if (reg_name == "s13") return maat::ir::Reg(maat::ARM64::Z13, 31, 0);
    if (reg_name == "s14") return maat::ir::Reg(maat::ARM64::Z14, 31, 0);
    if (reg_name == "s15") return maat::ir::Reg(maat::ARM64::Z15, 31, 0);
    if (reg_name == "s16") return maat::ir::Reg(maat::ARM64::Z16, 31, 0);
    if (reg_name == "s17") return maat::ir::Reg(maat::ARM64::Z17, 31, 0);
    if (reg_name == "s18") return maat::ir::Reg(maat::ARM64::Z18, 31, 0);
    if (reg_name == "s19") return maat::ir::Reg(maat::ARM64::Z19, 31, 0);
    if (reg_name == "s20") return maat::ir::Reg(maat::ARM64::Z20, 31, 0);
    if (reg_name == "s21") return maat::ir::Reg(maat::ARM64::Z21, 31, 0);
    if (reg_name == "s22") return maat::ir::Reg(maat::ARM64::Z22, 31, 0);
    if (reg_name == "s23") return maat::ir::Reg(maat::ARM64::Z23, 31, 0);
    if (reg_name == "s24") return maat::ir::Reg(maat::ARM64::Z24, 31, 0);
    if (reg_name == "s25") return maat::ir::Reg(maat::ARM64::Z25, 31, 0);
    if (reg_name == "s26") return maat::ir::Reg(maat::ARM64::Z26, 31, 0);
    if (reg_name == "s27") return maat::ir::Reg(maat::ARM64::Z27, 31, 0);
    if (reg_name == "s28") return maat::ir::Reg(maat::ARM64::Z28, 31, 0);
    if (reg_name == "s29") return maat::ir::Reg(maat::ARM64::Z29, 31, 0);
    if (reg_name == "s30") return maat::ir::Reg(maat::ARM64::Z30, 31, 0);
    if (reg_name == "s31") return maat::ir::Reg(maat::ARM64::Z31, 31, 0);
    
    // H registers (16-bit)
    if (reg_name == "h0") return maat::ir::Reg(maat::ARM64::Z0, 15, 0);
    if (reg_name == "h1") return maat::ir::Reg(maat::ARM64::Z1, 15, 0);
    if (reg_name == "h2") return maat::ir::Reg(maat::ARM64::Z2, 15, 0);
    if (reg_name == "h3") return maat::ir::Reg(maat::ARM64::Z3, 15, 0);
    if (reg_name == "h4") return maat::ir::Reg(maat::ARM64::Z4, 15, 0);
    if (reg_name == "h5") return maat::ir::Reg(maat::ARM64::Z5, 15, 0);
    if (reg_name == "h6") return maat::ir::Reg(maat::ARM64::Z6, 15, 0);
    if (reg_name == "h7") return maat::ir::Reg(maat::ARM64::Z7, 15, 0);
    if (reg_name == "h8") return maat::ir::Reg(maat::ARM64::Z8, 15, 0);
    if (reg_name == "h9") return maat::ir::Reg(maat::ARM64::Z9, 15, 0);
    if (reg_name == "h10") return maat::ir::Reg(maat::ARM64::Z10, 15, 0);
    if (reg_name == "h11") return maat::ir::Reg(maat::ARM64::Z11, 15, 0);
    if (reg_name == "h12") return maat::ir::Reg(maat::ARM64::Z12, 15, 0);
    if (reg_name == "h13") return maat::ir::Reg(maat::ARM64::Z13, 15, 0);
    if (reg_name == "h14") return maat::ir::Reg(maat::ARM64::Z14, 15, 0);
    if (reg_name == "h15") return maat::ir::Reg(maat::ARM64::Z15, 15, 0);
    if (reg_name == "h16") return maat::ir::Reg(maat::ARM64::Z16, 15, 0);
    if (reg_name == "h17") return maat::ir::Reg(maat::ARM64::Z17, 15, 0);
    if (reg_name == "h18") return maat::ir::Reg(maat::ARM64::Z18, 15, 0);
    if (reg_name == "h19") return maat::ir::Reg(maat::ARM64::Z19, 15, 0);
    if (reg_name == "h20") return maat::ir::Reg(maat::ARM64::Z20, 15, 0);
    if (reg_name == "h21") return maat::ir::Reg(maat::ARM64::Z21, 15, 0);
    if (reg_name == "h22") return maat::ir::Reg(maat::ARM64::Z22, 15, 0);
    if (reg_name == "h23") return maat::ir::Reg(maat::ARM64::Z23, 15, 0);
    if (reg_name == "h24") return maat::ir::Reg(maat::ARM64::Z24, 15, 0);
    if (reg_name == "h25") return maat::ir::Reg(maat::ARM64::Z25, 15, 0);
    if (reg_name == "h26") return maat::ir::Reg(maat::ARM64::Z26, 15, 0);
    if (reg_name == "h27") return maat::ir::Reg(maat::ARM64::Z27, 15, 0);
    if (reg_name == "h28") return maat::ir::Reg(maat::ARM64::Z28, 15, 0);
    if (reg_name == "h29") return maat::ir::Reg(maat::ARM64::Z29, 15, 0);
    if (reg_name == "h30") return maat::ir::Reg(maat::ARM64::Z30, 15, 0);
    if (reg_name == "h31") return maat::ir::Reg(maat::ARM64::Z31, 15, 0);
    
    // B registers (8-bit)
    if (reg_name == "b0") return maat::ir::Reg(maat::ARM64::Z0, 7, 0);
    if (reg_name == "b1") return maat::ir::Reg(maat::ARM64::Z1, 7, 0);
    if (reg_name == "b2") return maat::ir::Reg(maat::ARM64::Z2, 7, 0);
    if (reg_name == "b3") return maat::ir::Reg(maat::ARM64::Z3, 7, 0);
    if (reg_name == "b4") return maat::ir::Reg(maat::ARM64::Z4, 7, 0);
    if (reg_name == "b5") return maat::ir::Reg(maat::ARM64::Z5, 7, 0);
    if (reg_name == "b6") return maat::ir::Reg(maat::ARM64::Z6, 7, 0);
    if (reg_name == "b7") return maat::ir::Reg(maat::ARM64::Z7, 7, 0);
    if (reg_name == "b8") return maat::ir::Reg(maat::ARM64::Z8, 7, 0);
    if (reg_name == "b9") return maat::ir::Reg(maat::ARM64::Z9, 7, 0);
    if (reg_name == "b10") return maat::ir::Reg(maat::ARM64::Z10, 7, 0);
    if (reg_name == "b11") return maat::ir::Reg(maat::ARM64::Z11, 7, 0);
    if (reg_name == "b12") return maat::ir::Reg(maat::ARM64::Z12, 7, 0);
    if (reg_name == "b13") return maat::ir::Reg(maat::ARM64::Z13, 7, 0);
    if (reg_name == "b14") return maat::ir::Reg(maat::ARM64::Z14, 7, 0);
    if (reg_name == "b15") return maat::ir::Reg(maat::ARM64::Z15, 7, 0);
    if (reg_name == "b16") return maat::ir::Reg(maat::ARM64::Z16, 7, 0);
    if (reg_name == "b17") return maat::ir::Reg(maat::ARM64::Z17, 7, 0);
    if (reg_name == "b18") return maat::ir::Reg(maat::ARM64::Z18, 7, 0);
    if (reg_name == "b19") return maat::ir::Reg(maat::ARM64::Z19, 7, 0);
    if (reg_name == "b20") return maat::ir::Reg(maat::ARM64::Z20, 7, 0);
    if (reg_name == "b21") return maat::ir::Reg(maat::ARM64::Z21, 7, 0);
    if (reg_name == "b22") return maat::ir::Reg(maat::ARM64::Z22, 7, 0);
    if (reg_name == "b23") return maat::ir::Reg(maat::ARM64::Z23, 7, 0);
    if (reg_name == "b24") return maat::ir::Reg(maat::ARM64::Z24, 7, 0);
    if (reg_name == "b25") return maat::ir::Reg(maat::ARM64::Z25, 7, 0);
    if (reg_name == "b26") return maat::ir::Reg(maat::ARM64::Z26, 7, 0);
    if (reg_name == "b27") return maat::ir::Reg(maat::ARM64::Z27, 7, 0);
    if (reg_name == "b28") return maat::ir::Reg(maat::ARM64::Z28, 7, 0);
    if (reg_name == "b29") return maat::ir::Reg(maat::ARM64::Z29, 7, 0);
    if (reg_name == "b30") return maat::ir::Reg(maat::ARM64::Z30, 7, 0);
    if (reg_name == "b31") return maat::ir::Reg(maat::ARM64::Z31, 7, 0);
    
    // Z registers (SVE)
    if (reg_name == "z0") return maat::ir::Reg(maat::ARM64::Z0, 255, 0);
    if (reg_name == "z1") return maat::ir::Reg(maat::ARM64::Z1, 255, 0);
    if (reg_name == "z2") return maat::ir::Reg(maat::ARM64::Z2, 255, 0);
    if (reg_name == "z3") return maat::ir::Reg(maat::ARM64::Z3, 255, 0);
    if (reg_name == "z4") return maat::ir::Reg(maat::ARM64::Z4, 255, 0);
    if (reg_name == "z5") return maat::ir::Reg(maat::ARM64::Z5, 255, 0);
    if (reg_name == "z6") return maat::ir::Reg(maat::ARM64::Z6, 255, 0);
    if (reg_name == "z7") return maat::ir::Reg(maat::ARM64::Z7, 255, 0);
    if (reg_name == "z8") return maat::ir::Reg(maat::ARM64::Z8, 255, 0);
    if (reg_name == "z9") return maat::ir::Reg(maat::ARM64::Z9, 255, 0);
    if (reg_name == "z10") return maat::ir::Reg(maat::ARM64::Z10, 255, 0);
    if (reg_name == "z11") return maat::ir::Reg(maat::ARM64::Z11, 255, 0);
    if (reg_name == "z12") return maat::ir::Reg(maat::ARM64::Z12, 255, 0);
    if (reg_name == "z13") return maat::ir::Reg(maat::ARM64::Z13, 255, 0);
    if (reg_name == "z14") return maat::ir::Reg(maat::ARM64::Z14, 255, 0);
    if (reg_name == "z15") return maat::ir::Reg(maat::ARM64::Z15, 255, 0);
    if (reg_name == "z16") return maat::ir::Reg(maat::ARM64::Z16, 255, 0);
    if (reg_name == "z17") return maat::ir::Reg(maat::ARM64::Z17, 255, 0);
    if (reg_name == "z18") return maat::ir::Reg(maat::ARM64::Z18, 255, 0);
    if (reg_name == "z19") return maat::ir::Reg(maat::ARM64::Z19, 255, 0);
    if (reg_name == "z20") return maat::ir::Reg(maat::ARM64::Z20, 255, 0);
    if (reg_name == "z21") return maat::ir::Reg(maat::ARM64::Z21, 255, 0);
    if (reg_name == "z22") return maat::ir::Reg(maat::ARM64::Z22, 255, 0);
    if (reg_name == "z23") return maat::ir::Reg(maat::ARM64::Z23, 255, 0);
    if (reg_name == "z24") return maat::ir::Reg(maat::ARM64::Z24, 255, 0);
    if (reg_name == "z25") return maat::ir::Reg(maat::ARM64::Z25, 255, 0);
    if (reg_name == "z26") return maat::ir::Reg(maat::ARM64::Z26, 255, 0);
    if (reg_name == "z27") return maat::ir::Reg(maat::ARM64::Z27, 255, 0);
    if (reg_name == "z28") return maat::ir::Reg(maat::ARM64::Z28, 255, 0);
    if (reg_name == "z29") return maat::ir::Reg(maat::ARM64::Z29, 255, 0);
    if (reg_name == "z30") return maat::ir::Reg(maat::ARM64::Z30, 255, 0);
    if (reg_name == "z31") return maat::ir::Reg(maat::ARM64::Z31, 255, 0);
    
    // V registers (128-bit)
    if (reg_name == "v0") return maat::ir::Reg(maat::ARM64::Z0, 127, 0);
    if (reg_name == "v1") return maat::ir::Reg(maat::ARM64::Z1, 127, 0);
    if (reg_name == "v2") return maat::ir::Reg(maat::ARM64::Z2, 127, 0);
    if (reg_name == "v3") return maat::ir::Reg(maat::ARM64::Z3, 127, 0);
    if (reg_name == "v4") return maat::ir::Reg(maat::ARM64::Z4, 127, 0);
    if (reg_name == "v5") return maat::ir::Reg(maat::ARM64::Z5, 127, 0);
    if (reg_name == "v6") return maat::ir::Reg(maat::ARM64::Z6, 127, 0);
    if (reg_name == "v7") return maat::ir::Reg(maat::ARM64::Z7, 127, 0);
    if (reg_name == "v8") return maat::ir::Reg(maat::ARM64::Z8, 127, 0);
    if (reg_name == "v9") return maat::ir::Reg(maat::ARM64::Z9, 127, 0);
    if (reg_name == "v10") return maat::ir::Reg(maat::ARM64::Z10, 127, 0);
    if (reg_name == "v11") return maat::ir::Reg(maat::ARM64::Z11, 127, 0);
    if (reg_name == "v12") return maat::ir::Reg(maat::ARM64::Z12, 127, 0);
    if (reg_name == "v13") return maat::ir::Reg(maat::ARM64::Z13, 127, 0);
    if (reg_name == "v14") return maat::ir::Reg(maat::ARM64::Z14, 127, 0);
    if (reg_name == "v15") return maat::ir::Reg(maat::ARM64::Z15, 127, 0);
    if (reg_name == "v16") return maat::ir::Reg(maat::ARM64::Z16, 127, 0);
    if (reg_name == "v17") return maat::ir::Reg(maat::ARM64::Z17, 127, 0);
    if (reg_name == "v18") return maat::ir::Reg(maat::ARM64::Z18, 127, 0);
    if (reg_name == "v19") return maat::ir::Reg(maat::ARM64::Z19, 127, 0);
    if (reg_name == "v20") return maat::ir::Reg(maat::ARM64::Z20, 127, 0);
    if (reg_name == "v21") return maat::ir::Reg(maat::ARM64::Z21, 127, 0);
    if (reg_name == "v22") return maat::ir::Reg(maat::ARM64::Z22, 127, 0);
    if (reg_name == "v23") return maat::ir::Reg(maat::ARM64::Z23, 127, 0);
    if (reg_name == "v24") return maat::ir::Reg(maat::ARM64::Z24, 127, 0);
    if (reg_name == "v25") return maat::ir::Reg(maat::ARM64::Z25, 127, 0);
    if (reg_name == "v26") return maat::ir::Reg(maat::ARM64::Z26, 127, 0);
    if (reg_name == "v27") return maat::ir::Reg(maat::ARM64::Z27, 127, 0);
    if (reg_name == "v28") return maat::ir::Reg(maat::ARM64::Z28, 127, 0);
    if (reg_name == "v29") return maat::ir::Reg(maat::ARM64::Z29, 127, 0);
    if (reg_name == "v30") return maat::ir::Reg(maat::ARM64::Z30, 127, 0);
    if (reg_name == "v31") return maat::ir::Reg(maat::ARM64::Z31, 127, 0);
